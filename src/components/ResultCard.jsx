...
<p className="mt-1 text-sm text-slate-500">
  AI-generated analysis and practical recommendations for your campus issue.
</p>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <span
              className={`rounded-full border px-4 py-2 text-sm font-semibold ${
                priorityClasses[result.priority] ||
                priorityClasses.Low
              }`}
            >
...
<div className="border-t border-slate-100 bg-slate-50 px-6 py-4">
  <p className="text-xs leading-5 text-slate-500">
    ...
    decision-making. It may not account for all campus-specific conditions.
    Verify recommendations with relevant campus staff before taking action.
  </p>
</div>
